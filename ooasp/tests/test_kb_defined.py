...
def test_kb_create():
    ...
    assert "ooasp_attr(frame,frame_position,enumint)." in racks_kb.fb.asp_str()
...
def test_kb_assoc():
    ...
    assert ('frame_modules', 'frame', 1, 1) in assoc1
    assert ('element_modules', 'element', 0, 1) in assoc1
    assert ('element_modules1', 'elementA', 1, 1) in assoc1
