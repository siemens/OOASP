...
def new_metrof_iconf():
    metro_kb = OOASPKnowledgeBase.from_file("metro_v1",settings.metrof_example_kb)
    return InteractiveConfigurator(metro_kb,"i1",[settings.metrof_example_constraints])
