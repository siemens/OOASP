...
The Configurations are handled using the `Config` class in [ooasp/config.py](ooasp/config.py). This class provides usefully functionality to load, edit, and visualize Knowledge Bases.
